...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
        ...
        /* Added final to indicate how maximum num of semaphores */
       	public final static int MAX_NUM_SEMA = 2;
         ...
         */
        // TODO - You fill in here.
        private SimpleSemaphore[] mSemaphores = new SimpleSemaphore[MAX_NUM_SEMA];
        ...
        public void run() {
        	...
        	for (int i = 0; i < mMaxLoopIterations; ++i) {
        		...
        		acquire();
        		System.out.println(mPlayString + "(" + (i+1) + ")");
        		release();
        		
        	}
        	
        	// Thread finished, reduce count of CountDownLatch
        	mLatch.countDown();
    ...
    public static void process(String startString, 
        ...
        // constructor call.
        mLatch = new CountDownLatch(PlayPingPongThread.MAX_NUM_SEMA);
